...
namespace BooksInBulk.Areas.Customer.Controllers
{
    [Area("customer")]
    [Authorize]
    public class CartController : Controller
    {
        ...
        public IActionResult Summary()
        {
            ...
            // Populate the OrderHeader fields with user data
            ...
            return View(ShoppingCartVM);  // Return the view with ShoppingCartVM
        }
        [HttpPost]
        [ActionName("Summary")]
        public IActionResult SummaryPOST()
        {
            ...
            // Set the PaymentStatus based on whether the user has a company
            ...
            if (applicationUser.CompanyId.GetValueOrDefault() == 0) 
            {
                var domain = "http://localhost:5138/";
                var options = new SessionCreateOptions
                {
                    SuccessUrl = domain + $"customer/cart/OrderConfirmation?id={ShoppingCartVM.OrderHeader.Id}", // Corrected the query parameter format
